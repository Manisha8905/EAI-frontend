...
function CreateCampaignModal({ defaultChannel, onClose, onCreate }) {
  ...
  const handleSubmit = (action) => {
    ...
    onCreate({
      ...
      // Include all form fields for persistence
      communicationType: form.communicationType,
      startTime: form.startTime,
      startAmPm: form.startAmPm,
      endTime: form.endTime,
      endAmPm: form.endAmPm,
      reengageDays: form.reengageDays,
      maxAttempts: form.maxAttempts,
      channelOrder: form.channelOrder,
      waitHours: form.waitHours,
      waitMinutes: form.waitMinutes,
      campaignPrompt: form.campaignPrompt,
      modelName: form.modelName,
      agentName: form.agentName,
      loggedInEmail: form.loggedInEmail,
      parallelCalls: form.parallelCalls,
      listId: form.listId,
      smtpProvider: form.smtpProvider,
      templateId: form.templateId,
      fromName: form.fromName,
      fromEmail: form.fromEmail,
      replyToEmail: form.replyToEmail,
      aiPersonalization: form.aiPersonalization,
      aiTone: form.aiTone,
      aiContext: form.aiContext,
      emailsPerBatch: form.emailsPerBatch,
      batchDelay: form.batchDelay,
      connectionNoteTemplate: form.connectionNoteTemplate,
      dmBodyTemplate: form.dmBodyTemplate,
      linkedinMaxAttempts: form.linkedinMaxAttempts,
      whatsappTemplate: form.whatsappTemplate,
      whatsappMaxAttempts: form.whatsappMaxAttempts,
              ...
              {form.channelOrder.includes("EMAIL") && (
                <div className="rounded-xl border border-indigo-200 bg-indigo-50/40 p-4 space-y-3">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <p className="text-[12px] font-[700] text-indigo-700">Email Config</p>
                  </div>
                  <div className="grid grid-cols-2 gap-3">
                    <div className="rounded-xl border border-indigo-100 bg-white px-3 py-3 flex items-center justify-between">
                    ...
                    <div className="rounded-xl border border-indigo-100 bg-white px-3 py-3 flex items-center justify-between">
                      <div className="min-w-0 mr-2">
                        <p className="text-[12px] font-[700] text-gray-800 leading-tight">Preview Mode</p>
